...
(function () {
  var I18N = {
    nl: {
      ...
      "prijzen.tSingle": "1-persoons",
      "prijzen.tDouble": "2-persoons",
      "prijzen.card1": "1 dag",
      "prijzen.card3": "3 dagen",
      "prijzen.card7": "1 week",
      "prijzen.perday": "per dag",
      "prijzen.total": "totaal",
      "prijzen.save": "Bespaar",
      "prijzen.popular": "Meest gekozen",
      "prijzen.cta": "Boek deze deal",
      "autos.allrisk": "All-risk inbegrepen",
      "autos.day": "/ dag",
      "autos.cta": "Boek deze auto",
      "autos.k1": "Compact",
      "autos.n1": "4-deurs auto",
      "autos.s1": "4 pers · 2 koffers · airco",
      "autos.k2": "SUV",
      "autos.n2": "4-deurs SUV",
      "autos.s2": "5 pers · 3 koffers · stoer terrein",
      "autos.k3": "Pickup",
      "autos.n3": "Double Cab Pickup",
      "autos.s3": "4 pers · 3 koffers · open laadbak",
      "routes.lead": "Bonaire is maar 39 km lang. Eén tank en je hebt het hele eiland gezien.",
      "routes.c1a": "Pekelmeer", "routes.c1b": "Slavenhutten", "routes.c1c": "Roze water",
      "routes.c2a": "Gotomeer", "routes.c2b": "Rincon", "routes.c2c": "Flamingo’s",
      "routes.c3a": "1000 Steps", "routes.c3b": "Seru Largu", "routes.c3c": "Sorobon",
      "routes.dist1": "± 25 km", "routes.dist2": "± 35 km", "routes.dist3": "± 20 km",
      "boeken.support": "Jij kiest, wij bevestigen de beschikbaarheid via WhatsApp. Geen account, geen gedoe.",
      ...
      "prijzen.claim": "Hoe langer je rijdt, hoe minder je per dag betaalt.",
      "prijzen.incl": "Alle prijzen inclusief verzekering, BTW, helm en slot.",

      "autos.kicker": "Macho! Auto’s",
      "autos.title": "Ook op vier wielen.",
      "autos.sub": "Vanaf $85 per dag, all-risk verzekering inbegrepen. Gratis ophalen bij je hotel of het vliegveld.",
      ...
      "boeken.title": "Boek in 30 seconden.",
    ...
    en: {
      ...
      "prijzen.tSingle": "1-seater",
      "prijzen.tDouble": "2-seater",
      "prijzen.card1": "1 day",
      "prijzen.card3": "3 days",
      "prijzen.card7": "1 week",
      "prijzen.perday": "per day",
      "prijzen.total": "total",
      "prijzen.save": "Save",
      "prijzen.popular": "Most chosen",
      "prijzen.cta": "Book this deal",
      "autos.allrisk": "All-risk included",
      "autos.day": "/ day",
      "autos.cta": "Book this car",
      "autos.k1": "Compact",
      "autos.n1": "4-door car",
      "autos.s1": "4 people · 2 bags · A/C",
      "autos.k2": "SUV",
      "autos.n2": "4-door SUV",
      "autos.s2": "5 people · 3 bags · rugged terrain",
      "autos.k3": "Pickup",
      "autos.n3": "Double Cab Pickup",
      "autos.s3": "4 people · 3 bags · open bed",
      "routes.lead": "Bonaire is only 39 km long. One tank and you’ve seen the whole island.",
      "routes.c1a": "Pekelmeer", "routes.c1b": "Slave huts", "routes.c1c": "Pink water",
      "routes.c2a": "Gotomeer", "routes.c2b": "Rincon", "routes.c2c": "Flamingos",
      "routes.c3a": "1000 Steps", "routes.c3b": "Seru Largu", "routes.c3c": "Sorobon",
      "routes.dist1": "± 25 km", "routes.dist2": "± 35 km", "routes.dist3": "± 20 km",
      "boeken.support": "You choose, we confirm availability over WhatsApp. No account, no hassle.",
      "cta.eyebrow": "Enjoy the ride",
      "marquee.a": "ENJOY THE RIDE",
      "marquee.b": "CHOOSE WISELY, CHOOSE MACHO!",
      "hero.cta1": "Book now",
      ...
      "prijzen.claim": "The longer you ride, the less you pay per day.",
      "prijzen.incl": "All rates include insurance, VAT, helmet and lock.",

      "autos.kicker": "Macho! Cars",
      "autos.title": "Four wheels, same Macho.",
      "autos.sub": "From $85 a day, all-risk insurance included. Free pick-up at your hotel or the airport.",
      ...
      "boeken.title": "Book in 30 seconds.",
